...
from src.utils.paths import get_config_path, get_model_path, get_data_path
...
MODELS = {
    'Wizard Wave (1D)': {
        'old_file': get_model_path('model_1d.pkl'),
        'new_file': get_model_path('wizard_wave_ml_model.pkl'),
        'interval': '1d',
    ...
    'Wizard Scalp (1H)': {
        'old_file': get_model_path('model_1h.pkl'),
        'new_file': get_model_path('wizard_scalp_ml_model.pkl'),
        'interval': '1h',
...
def fetch_data(symbol, interval):
    ...
    cache_path = os.path.join(get_data_path('cache'), f"{cache_name}_{interval}.csv")
